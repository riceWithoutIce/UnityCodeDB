...
{
  "dependencies": {
    "com.rice.ai-codedb": "https://github.com/riceWithoutIce/UnityCodeDB.git?path=/com.rice.ai-codedb#main"
  }
}
```

After a version tag is published, pin production projects to that tag instead
of `main`, for example `#v0.1.0`.
