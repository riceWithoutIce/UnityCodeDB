...
Assert-Equal -Actual $payloadManifest.payload_version -Expected "poc.16" -Label "Payload version"
Assert-Equal -Actual $payloadManifest.payload_sequence -Expected 16 -Label "Payload sequence"
