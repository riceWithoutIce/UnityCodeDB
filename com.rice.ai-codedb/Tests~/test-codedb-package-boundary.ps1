...
Assert-Equal -Actual $payloadManifest.payload_version -Expected "poc.15" -Label "Payload version"
Assert-Equal -Actual $payloadManifest.payload_sequence -Expected 15 -Label "Payload sequence"
