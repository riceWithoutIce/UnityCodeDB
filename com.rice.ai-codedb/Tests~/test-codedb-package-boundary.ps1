...
Assert-Equal -Actual $payloadManifest.payload_version -Expected "poc.10" -Label "Payload version"
Assert-Equal -Actual $payloadManifest.payload_sequence -Expected 10 -Label "Payload sequence"
