...
Assert-Equal -Actual $payloadManifest.payload_version -Expected "poc.11" -Label "Payload version"
Assert-Equal -Actual $payloadManifest.payload_sequence -Expected 11 -Label "Payload sequence"
