...
namespace Rice.AI.Codedb.Editor
{
    internal static class AICodedbProjectSettings
    {
        ...
        internal const string CurrentPackageVersion = "0.2.4-preview.3";
        internal const string CurrentPayloadVersion = "poc.25";
        internal const string CurrentGenerationId = "poc.25";
        internal const int CurrentPayloadSequence = 25;
