...
$prerequisite = Get-CodedbMachinePrerequisiteStatus
$expectedProviderFolder = if ([string]::IsNullOrWhiteSpace($env:LOCALAPPDATA)) {
    "%LOCALAPPDATA%\Rice\CodeDB\providers\0.5.0-28e3912-c2"
} else {
    Join-Path $env:LOCALAPPDATA "Rice\CodeDB\providers\0.5.0-28e3912-c2"
}
...
Write-Host ""
Write-Host "Provider:"
Write-Host "- Required Provider: killop/codedb-mcp 0.5.0-28e3912-c2."
Write-Host "- Required protocol: codedb-cli-v1."
Write-Host "- Required capability contract: codedb-search-tools-v1."
