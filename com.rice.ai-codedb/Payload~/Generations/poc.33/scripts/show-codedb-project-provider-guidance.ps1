...
$expectedProviderFolder = if ([string]::IsNullOrWhiteSpace($env:LOCALAPPDATA)) {
    "%LOCALAPPDATA%\Rice\CodeDB\providers\0.5.0-28e3912"
} else {
    Join-Path $env:LOCALAPPDATA "Rice\CodeDB\providers\0.5.0-28e3912"
}
...
Write-Host ""
Write-Host "Provider:"
Write-Host "- Required Provider: killop/codedb-mcp 0.5.0-28e3912."
