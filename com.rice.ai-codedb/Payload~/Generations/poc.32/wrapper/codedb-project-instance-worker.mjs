...
function resolveMachineProvider() {
  ...
  if (!fs.existsSync(providerRoot) || !fs.statSync(providerRoot).isDirectory()
    ...
    throw new Error("[MISSING_PREREQUISITE] CodeDB Provider 0.5.0 is missing under %LOCALAPPDATA%/Rice/CodeDB/providers/0.5.0.");
  }
